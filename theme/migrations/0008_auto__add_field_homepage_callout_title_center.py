...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'HomePage.callout_title_center'
        db.add_column(u'theme_homepage', 'callout_title_center',
                      self.gf('django.db.models.fields.CharField')(default='callout title center', max_length=20),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'HomePage.callout_title_center'
        db.delete_column(u'theme_homepage', 'callout_title_center')
