...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'HomePage.center_title'
        db.add_column(u'theme_homepage', 'center_title',
                      self.gf('django.db.models.fields.CharField')(default='Center Bottom Title', max_length=200),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'HomePage.center_title'
        db.delete_column(u'theme_homepage', 'center_title')
