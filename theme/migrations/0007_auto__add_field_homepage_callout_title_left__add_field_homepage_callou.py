...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'HomePage.callout_title_left'
        db.add_column(u'theme_homepage', 'callout_title_left',
                      self.gf('django.db.models.fields.CharField')(default='callout title center', max_length=20),
                      keep_default=False)

        # Adding field 'HomePage.callout_title_right'
        db.add_column(u'theme_homepage', 'callout_title_right',
                      self.gf('django.db.models.fields.CharField')(default='callout title right', max_length=20),
                      keep_default=False)


        # Changing field 'HomePage.calloutleft'
        db.alter_column(u'theme_homepage', 'calloutleft', self.gf('django.db.models.fields.CharField')(max_length=100))

        # Changing field 'HomePage.calloutcenter'
        db.alter_column(u'theme_homepage', 'calloutcenter', self.gf('django.db.models.fields.CharField')(max_length=100))

        # Changing field 'HomePage.calloutright'
        db.alter_column(u'theme_homepage', 'calloutright', self.gf('django.db.models.fields.CharField')(max_length=100))

    def backwards(self, orm):
        # Deleting field 'HomePage.callout_title_left'
        db.delete_column(u'theme_homepage', 'callout_title_left')

        # Deleting field 'HomePage.callout_title_right'
        db.delete_column(u'theme_homepage', 'callout_title_right')


        # Changing field 'HomePage.calloutleft'
        db.alter_column(u'theme_homepage', 'calloutleft', self.gf('django.db.models.fields.CharField')(max_length=200))

        # Changing field 'HomePage.calloutcenter'
        db.alter_column(u'theme_homepage', 'calloutcenter', self.gf('django.db.models.fields.CharField')(max_length=200))

        # Changing field 'HomePage.calloutright'
        db.alter_column(u'theme_homepage', 'calloutright', self.gf('django.db.models.fields.CharField')(max_length=200))
    ...
    models = {
        ...
        u'theme.homepage': {
            ...
            'callout_title_left': ('django.db.models.fields.CharField', [], {'default': "'callout title center'", 'max_length': '20'}),
