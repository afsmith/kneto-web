...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'HomePageInc.ip'
        db.add_column(u'theme_homepageinc', 'ip',
                      self.gf('django.db.models.fields.GenericIPAddressField')(default='192.168.0.0', max_length=39),
                      keep_default=False)

        # Adding field 'HomePageInc.county'
        db.add_column(u'theme_homepageinc', 'county',
                      self.gf('django.db.models.fields.CharField')(default='None', max_length=50),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'HomePageInc.ip'
        db.delete_column(u'theme_homepageinc', 'ip')

        # Deleting field 'HomePageInc.county'
        db.delete_column(u'theme_homepageinc', 'county')
