...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'HomePageInc.form_name'
        db.add_column(u'theme_homepageinc', 'form_name',
                      self.gf('django.db.models.fields.CharField')(default='NUL', max_length=100),
                      keep_default=False)

        # Adding field 'HomePageInc.date'
        db.add_column(u'theme_homepageinc', 'date',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2013, 10, 25, 0, 0)),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'HomePageInc.form_name'
        db.delete_column(u'theme_homepageinc', 'form_name')

        # Deleting field 'HomePageInc.date'
        db.delete_column(u'theme_homepageinc', 'date')
