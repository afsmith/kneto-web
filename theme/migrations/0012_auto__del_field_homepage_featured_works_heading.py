...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'HomePage.featured_works_heading'
        db.delete_column(u'theme_homepage', 'featured_works_heading')


    def backwards(self, orm):
        # Adding field 'HomePage.featured_works_heading'
        db.add_column(u'theme_homepage', 'featured_works_heading',
                      self.gf('django.db.models.fields.CharField')(default='Featured Works', max_length=200),
                      keep_default=False)
