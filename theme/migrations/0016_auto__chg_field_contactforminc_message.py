...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'ContactFormInc.message'
        db.alter_column(u'theme_contactforminc', 'message', self.gf('django.db.models.fields.CharField')(max_length=5000))

    def backwards(self, orm):

        # Changing field 'ContactFormInc.message'
        db.alter_column(u'theme_contactforminc', 'message', self.gf('django.db.models.fields.CharField')(max_length=200))
