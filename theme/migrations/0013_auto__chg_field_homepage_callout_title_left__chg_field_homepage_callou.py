...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        # Changing field 'HomePage.callout_title_left'
        db.alter_column(u'theme_homepage', 'callout_title_left', self.gf('django.db.models.fields.CharField')(max_length=20))

        # Changing field 'HomePage.callout_title_right'
        db.alter_column(u'theme_homepage', 'callout_title_right', self.gf('django.db.models.fields.CharField')(max_length=20))

        # Changing field 'HomePage.callout_title_center'
        db.alter_column(u'theme_homepage', 'callout_title_center', self.gf('django.db.models.fields.CharField')(max_length=20))
