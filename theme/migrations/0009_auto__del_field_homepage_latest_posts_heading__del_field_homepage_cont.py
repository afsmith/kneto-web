...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'HomePage.latest_posts_heading'
        db.delete_column(u'theme_homepage', 'latest_posts_heading')

        # Deleting field 'HomePage.content_heading'
        db.delete_column(u'theme_homepage', 'content_heading')

        # Adding field 'HomePage.center_bottom'
        db.add_column(u'theme_homepage', 'center_bottom',
                      self.gf('django.db.models.fields.CharField')(default='Center Bottom', max_length=200),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'HomePage.latest_posts_heading'
        db.add_column(u'theme_homepage', 'latest_posts_heading',
                      self.gf('django.db.models.fields.CharField')(default='Latest Posts', max_length=200),
                      keep_default=False)

        # Adding field 'HomePage.content_heading'
        db.add_column(u'theme_homepage', 'content_heading',
                      self.gf('django.db.models.fields.CharField')(default='About us!', max_length=200),
                      keep_default=False)

        # Deleting field 'HomePage.center_bottom'
        db.delete_column(u'theme_homepage', 'center_bottom')
